    ...
    while 1:
        ...
        if match := p_define.match(line):
            ...
            try:
                ...
                sys.stderr.write(f'Skipping: {stmt}')
            else:
                outfp.write(stmt)
        if match := p_macro.match(line):
